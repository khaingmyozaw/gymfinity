    ...
    <div class="w-auto h-16 sm:h-20 px-3 lg:px-8 bg-slate-700 bg-opacity-50">
        <div class="relative flex items-center justify-between">
            ...
            <div class="flex">
                ...
                {{-- Profile image --}}
                <button class="text-white rounded-full p-2 mr-2 hover:bg-white hover:bg-opacity-10">
                ...
                <div class="mr-2 felx items-center lg:hidden">
                    <button type="button" class="text-white inline-flex items-center justify-center rounded-md p-2 hover:bg-white hover:bg-opacity-10 hover:bg-gray-700  focus:outline-none focus:ring-1 focus:ring-inset focus:ring-slate-700 menu-btn" arial-controls="mobile-menu" aria-expanded="false">
