...
<div class="w-full h-auto pt-16 sm:pt-20 bg-pre-dark-green overflow-x-hidden">
    ...
    <div class="w-full">
        <div class="w-11/12 h-auto mx-auto">
            ...
            <div class="w-full h-auto sm:w-10/12 mx-auto p-1 sm:p-3 mt-2 sm:flex border border-white border-opacity-30 rounded-md">
                {{-- Avatar --}}
                <div>
                ...
                <div class="flex-1 h-full">
                  <form action="" method="">
                    ...
                    <div class="relative w-full h-12">
                      <button class="zeembibtn zeembibtn-success absolute w-24 right-0">Reply</button>
                      <button class="zeembibtn zeembibtn-active zeembibtn-neutral mr-3 absolute right-24">Cancle</button>
                    </div>
