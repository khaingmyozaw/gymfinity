...
@section('content')
<div class="w-full h-screen p-10 bg-pre-dark-green flex items-center justify-center overflow-auto">
    <div class="w-full md:w-3/4 h-auto min-h-10/12 max-h-11/12 mt-10 rounded bg-slate-100 shadow-md overflow-hidden flex">
        <div class="md:w-2/5 h-full overflow-hidden hidden md:block">
            <img src="{{ asset('images/woman.jpeg') }}" alt="login" class="size-full object-cover object-center">
        </div>
        <div class="w-full sm:4/5 md:w-3/5 h-full p-5">
            <h1 class="text-2xl font-bold text-pre-dark-green text-center">Gymfinity</h1>
            <form action="" method="" class="flex-1 w-full h-full size-full py-3 flex flex-col items-center justify-around">
                ...
                <button class="w-full md:w-4/5 py-2 mt-2 text-slate-100 bg-blue-700 bg-opacity-70 rounded">
                    Sign up
                </button>
            </form>
             <div class="text-center text-slate-600">
                Do you have an account? <a href="{{ route('signin') }}" class="underline text-blue-600">Sign in here</a>
            </div>
        </div>
    </div>
</div>
